...
// lib/permissions usado en páginas). Mismo patrón que parteturno/server/guards.ts.
...
// antes de haber guardado los totales del día. Mismo patrón que ensureParte (parteturno).
