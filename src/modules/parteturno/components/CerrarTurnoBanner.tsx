...
// el registro de movimientos. UN solo botón (decisión del dueño, 2026-09-10): el turno lo
// elige la cajera DESPUÉS de entrar, en /parte (TurnoSelector). El estado que se muestra aquí
// es el del turno sugerido por la hora — orientativo.
//
...
export function CerrarTurnoBanner({
  ...
  const texto = alerta
    ? estado === "BORRADOR"
      ? "El turno ya cerró y tu parte sigue sin enviar — envíalo"
