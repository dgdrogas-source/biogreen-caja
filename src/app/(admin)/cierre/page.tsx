...
// Hub "Cierre Biogreen": cada tipo de cierre vive en su propia ruta (no como pestañas de
// una sola página) para que cada uno pueda crecer sin saturar la pantalla.
