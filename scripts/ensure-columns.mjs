...
const statements = [
  ...
  // ---------------------------------------------------------------------------
  // Módulo PARTE DE TURNO (2026-07-29). Aditivo y aislado: la vendedora registra el cuadre
  // del POS y el admin lo aprueba; solo al aprobar se vuelca a CierreGeneral.
  // Ver prisma/migrations/20260729000000_parte_turno/.
  // ---------------------------------------------------------------------------
  ...
  // Trazabilidad: de qué parte salió cada gasto/factura ya volcado. Columnas SUELTAS (sin FK)
  ...
  // ---------------------------------------------------------------------------
  // MÓDULO CIERRE DIARIO (2026-09-09). Reemplaza a Cierre General (retirado del código en el
  // mismo cambio; sus tablas NO se tocan aquí — quedan sin usar, nunca DROP). Aditivo y
  // aislado. Ver prisma/migrations/20260909000000_cierre_diario/ y
  // .claude/PLAN-CIERRE-DIARIO-IMPLEMENTACION.md.
  // ---------------------------------------------------------------------------
  ...
  // (columnas ahí quedan sin uso, nunca DROP). Ver .claude/PLAN-CIERRE-DIARIO-AJUSTES-2026-09-10.md.
  // ---------------------------------------------------------------------------
